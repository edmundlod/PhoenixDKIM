...
mt.startfilter(binpath .. "/phoenixdkim", "-x", "t-verify-ss-ar-admd-less.conf",
               "-p", sock)
...
-- ADMD-less AR header: Office 365 style, no authserv-id before the result
...
-- end of message; ADMD-less AR headers should not cause rejection
