...
/* prototypes */
extern const char *config_check(struct config *, struct configdef *);
extern unsigned int config_dump(struct config *, FILE *, const char *);
extern const char *config_error(void);
extern void config_free(struct config *);
extern int config_get(struct config *, const char *, void *, size_t);
extern struct config *config_load(const char *, struct configdef *,
