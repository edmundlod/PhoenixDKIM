...
extern DKIM_STAT dkim_header(DKIM *dkim, const u_char *hdr, size_t len);
...
extern DKIM_STAT dkim_body(DKIM *dkim, const u_char *buf, size_t len);
...
extern DKIM_STAT dkim_chunk(DKIM *dkim, const u_char *buf, size_t buflen);
...
extern DKIM_STAT dkim_key_syntax(DKIM *dkim, const u_char *str,
                                      size_t len);
...
extern DKIM_STAT dkim_sig_syntax(DKIM *dkim, const u_char *str,
                                      size_t len);
...
extern _Bool dkim_sig_hdrsigned(DKIM_SIGINFO *sig, const u_char *hdr);
...
extern DKIM_STAT dkim_options(DKIM_LIB *lib, int op, dkim_opts_t opt,
                                   void *ptr, size_t len);
...
#define DKIM_FEATURE_ED25519		10
...
extern int dkim_qp_decode(const unsigned char *, unsigned char *, int);
